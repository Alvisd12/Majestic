      ...
      <div class="col-lg-6 col-md-12 fade-in">
        <div class="product-image">
          <div class="image-container">
            ...
            <img src="{{ asset('assets/images/motor3.jpg') }}" alt="Honda Beat Deluxe" class="img-fluid">
          </div>
          
          <h5 class="product-title">Honda Scoopy</h5>
      ...
      <div class="col-12 fade-in">
        <div class="info-card">
          ...
          <dl class="row info-list">
            ...
            <dd class="col-sm-9">Honda Sccopy (Matic)</dd>
