      ...
      <div class="col-lg-6 col-md-12 fade-in">
        <div class="product-image">
          <div class="image-container">
            ...
            <img src="{{ asset('assets/images/motor5.jpg') }}" alt="Honda Beat Deluxe" class="img-fluid">
          </div>
          
          <h5 class="product-title">Honda Vario 160</h5>
          <p class="product-subtitle">Motor matic terbaik untuk berkeliling Malang</p>
          
          <div class="stats-row">
            <div class="stat-item">
              <div class="stat-number">160cc</div>
      ...
      <div class="col-12 fade-in">
        <div class="info-card">
          ...
          <dl class="row info-list">
            ...
            <dd class="col-sm-9">Honda Vario 160 (Matic)</dd>
