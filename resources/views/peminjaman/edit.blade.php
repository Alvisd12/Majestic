                    ...
                    <form action="{{ route('peminjaman.update', $peminjaman->id) }}" method="POST">
                            ...
                            <select class="form-select" id="jenis_motor" name="jenis_motor" required>
                                ...
                                @foreach($motors as $motor)
                                    <option value="{{ $motor->merk }} {{ $motor->model }}" 
                                            ...
                                            {{ old('jenis_motor', $peminjaman->jenis_motor) == $motor->merk . ' ' . $motor->model ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="durasi_sewa" name="durasi_sewa" 
                                   value="{{ old('durasi_sewa', $peminjaman->durasi_sewa) }}" min="1" max="30" required>
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="card bg-light">
                                <div class="card-body">
                                    ...
                                    <p class="card-text fs-4 text-primary fw-bold" id="total-cost">Rp {{ number_format($peminjaman->total_harga, 0, ',', '.') }}</p>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('peminjaman.show', $peminjaman->id) }}" class="btn btn-secondary me-md-2">Cancel</a>
