            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control @error('jenis_motor') is-invalid @enderror" 
                        ...
                        <option value="Matic" {{ old('jenis_motor', $motor->jenis_motor) == 'Matic' ? 'selected' : '' }}>Matic</option>
                        <option value="Manual" {{ old('jenis_motor', $motor->jenis_motor) == 'Manual' ? 'selected' : '' }}>Manual</option>
                        <option value="Sport" {{ old('jenis_motor', $motor->jenis_motor) == 'Sport' ? 'selected' : '' }}>Sport</option>
                    </select>
                    @error('jenis_motor')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
